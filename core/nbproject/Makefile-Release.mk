...
${OBJECTDIR}/external/src/physfs_byteorder.o: external/src/physfs_byteorder.c 
	...
	${RM} $@.d
	$(COMPILE.c) -O2 -Iexternal/include -MMD -MP -MF $@.d -o ${OBJECTDIR}/external/src/physfs_byteorder.o external/src/physfs_byteorder.c

${OBJECTDIR}/external/src/posix.o: external/src/posix.c 
	${MKDIR} -p ${OBJECTDIR}/external/src
	${RM} $@.d
	$(COMPILE.c) -O2 -Iexternal/include -MMD -MP -MF $@.d -o ${OBJECTDIR}/external/src/posix.o external/src/posix.c

${OBJECTDIR}/external/src/grp.o: external/src/grp.c 
	${MKDIR} -p ${OBJECTDIR}/external/src
	${RM} $@.d
	$(COMPILE.c) -O2 -Iexternal/include -MMD -MP -MF $@.d -o ${OBJECTDIR}/external/src/grp.o external/src/grp.c
...
${OBJECTDIR}/external/src/wad.o: external/src/wad.c 
	${MKDIR} -p ${OBJECTDIR}/external/src
	${RM} $@.d
	$(COMPILE.c) -O2 -Iexternal/include -MMD -MP -MF $@.d -o ${OBJECTDIR}/external/src/wad.o external/src/wad.c

${OBJECTDIR}/external/src/unix.o: external/src/unix.c 
	${MKDIR} -p ${OBJECTDIR}/external/src
	${RM} $@.d
	$(COMPILE.c) -O2 -Iexternal/include -MMD -MP -MF $@.d -o ${OBJECTDIR}/external/src/unix.o external/src/unix.c

${OBJECTDIR}/external/src/physfs.o: external/src/physfs.c 
	${MKDIR} -p ${OBJECTDIR}/external/src
	${RM} $@.d
	$(COMPILE.c) -O2 -Iexternal/include -MMD -MP -MF $@.d -o ${OBJECTDIR}/external/src/physfs.o external/src/physfs.c

${OBJECTDIR}/external/src/7zHeader.o: external/src/7zHeader.c 
	${MKDIR} -p ${OBJECTDIR}/external/src
	${RM} $@.d
	$(COMPILE.c) -O2 -Iexternal/include -MMD -MP -MF $@.d -o ${OBJECTDIR}/external/src/7zHeader.o external/src/7zHeader.c

${OBJECTDIR}/external/src/hog.o: external/src/hog.c 
	${MKDIR} -p ${OBJECTDIR}/external/src
	${RM} $@.d
	$(COMPILE.c) -O2 -Iexternal/include -MMD -MP -MF $@.d -o ${OBJECTDIR}/external/src/hog.o external/src/hog.c

${OBJECTDIR}/external/src/BranchX86.o: external/src/BranchX86.c 
	${MKDIR} -p ${OBJECTDIR}/external/src
	${RM} $@.d
	$(COMPILE.c) -O2 -Iexternal/include -MMD -MP -MF $@.d -o ${OBJECTDIR}/external/src/BranchX86.o external/src/BranchX86.c
...
${OBJECTDIR}/external/src/7zAlloc.o: external/src/7zAlloc.c 
	${MKDIR} -p ${OBJECTDIR}/external/src
	${RM} $@.d
	$(COMPILE.c) -O2 -Iexternal/include -MMD -MP -MF $@.d -o ${OBJECTDIR}/external/src/7zAlloc.o external/src/7zAlloc.c

${OBJECTDIR}/external/src/zip.o: external/src/zip.c 
	${MKDIR} -p ${OBJECTDIR}/external/src
	${RM} $@.d
	$(COMPILE.c) -O2 -Iexternal/include -MMD -MP -MF $@.d -o ${OBJECTDIR}/external/src/zip.o external/src/zip.c

${OBJECTDIR}/external/src/pocketpc.o: external/src/pocketpc.c 
	${MKDIR} -p ${OBJECTDIR}/external/src
	${RM} $@.d
	$(COMPILE.c) -O2 -Iexternal/include -MMD -MP -MF $@.d -o ${OBJECTDIR}/external/src/pocketpc.o external/src/pocketpc.c

${OBJECTDIR}/external/src/physfs_unicode.o: external/src/physfs_unicode.c 
	${MKDIR} -p ${OBJECTDIR}/external/src
	${RM} $@.d
	$(COMPILE.c) -O2 -Iexternal/include -MMD -MP -MF $@.d -o ${OBJECTDIR}/external/src/physfs_unicode.o external/src/physfs_unicode.c

${OBJECTDIR}/external/src/mvl.o: external/src/mvl.c 
	${MKDIR} -p ${OBJECTDIR}/external/src
	${RM} $@.d
	$(COMPILE.c) -O2 -Iexternal/include -MMD -MP -MF $@.d -o ${OBJECTDIR}/external/src/mvl.o external/src/mvl.c

${OBJECTDIR}/external/src/7zBuffer.o: external/src/7zBuffer.c 
	${MKDIR} -p ${OBJECTDIR}/external/src
	${RM} $@.d
	$(COMPILE.c) -O2 -Iexternal/include -MMD -MP -MF $@.d -o ${OBJECTDIR}/external/src/7zBuffer.o external/src/7zBuffer.c

${OBJECTDIR}/external/src/7zIn.o: external/src/7zIn.c 
	${MKDIR} -p ${OBJECTDIR}/external/src
	${RM} $@.d
	$(COMPILE.c) -O2 -Iexternal/include -MMD -MP -MF $@.d -o ${OBJECTDIR}/external/src/7zIn.o external/src/7zIn.c
...
${OBJECTDIR}/external/src/7zItem.o: external/src/7zItem.c 
	${MKDIR} -p ${OBJECTDIR}/external/src
	${RM} $@.d
	$(COMPILE.c) -O2 -Iexternal/include -MMD -MP -MF $@.d -o ${OBJECTDIR}/external/src/7zItem.o external/src/7zItem.c

${OBJECTDIR}/external/src/7zDecode.o: external/src/7zDecode.c 
	${MKDIR} -p ${OBJECTDIR}/external/src
	${RM} $@.d
	$(COMPILE.c) -O2 -Iexternal/include -MMD -MP -MF $@.d -o ${OBJECTDIR}/external/src/7zDecode.o external/src/7zDecode.c
...
${OBJECTDIR}/external/src/windows.o: external/src/windows.c 
	${MKDIR} -p ${OBJECTDIR}/external/src
	${RM} $@.d
	$(COMPILE.c) -O2 -Iexternal/include -MMD -MP -MF $@.d -o ${OBJECTDIR}/external/src/windows.o external/src/windows.c

${OBJECTDIR}/external/src/os2.o: external/src/os2.c 
	${MKDIR} -p ${OBJECTDIR}/external/src
	${RM} $@.d
	$(COMPILE.c) -O2 -Iexternal/include -MMD -MP -MF $@.d -o ${OBJECTDIR}/external/src/os2.o external/src/os2.c

${OBJECTDIR}/external/src/lzma.o: external/src/lzma.c 
	${MKDIR} -p ${OBJECTDIR}/external/src
	${RM} $@.d
	$(COMPILE.c) -O2 -Iexternal/include -MMD -MP -MF $@.d -o ${OBJECTDIR}/external/src/lzma.o external/src/lzma.c

${OBJECTDIR}/external/src/7zExtract.o: external/src/7zExtract.c 
	${MKDIR} -p ${OBJECTDIR}/external/src
	${RM} $@.d
	$(COMPILE.c) -O2 -Iexternal/include -MMD -MP -MF $@.d -o ${OBJECTDIR}/external/src/7zExtract.o external/src/7zExtract.c

${OBJECTDIR}/external/src/BranchX86_2.o: external/src/BranchX86_2.c 
	${MKDIR} -p ${OBJECTDIR}/external/src
	${RM} $@.d
	$(COMPILE.c) -O2 -Iexternal/include -MMD -MP -MF $@.d -o ${OBJECTDIR}/external/src/BranchX86_2.o external/src/BranchX86_2.c
...
${OBJECTDIR}/external/src/macosx.o: external/src/macosx.c 
	${MKDIR} -p ${OBJECTDIR}/external/src
	${RM} $@.d
	$(COMPILE.c) -O2 -Iexternal/include -MMD -MP -MF $@.d -o ${OBJECTDIR}/external/src/macosx.o external/src/macosx.c

${OBJECTDIR}/external/src/7zMethodID.o: external/src/7zMethodID.c 
	${MKDIR} -p ${OBJECTDIR}/external/src
	${RM} $@.d
	$(COMPILE.c) -O2 -Iexternal/include -MMD -MP -MF $@.d -o ${OBJECTDIR}/external/src/7zMethodID.o external/src/7zMethodID.c

${OBJECTDIR}/external/src/qpak.o: external/src/qpak.c 
	${MKDIR} -p ${OBJECTDIR}/external/src
	${RM} $@.d
	$(COMPILE.c) -O2 -Iexternal/include -MMD -MP -MF $@.d -o ${OBJECTDIR}/external/src/qpak.o external/src/qpak.c

${OBJECTDIR}/external/src/LzmaDecode.o: external/src/LzmaDecode.c 
	${MKDIR} -p ${OBJECTDIR}/external/src
	${RM} $@.d
	$(COMPILE.c) -O2 -Iexternal/include -MMD -MP -MF $@.d -o ${OBJECTDIR}/external/src/LzmaDecode.o external/src/LzmaDecode.c
